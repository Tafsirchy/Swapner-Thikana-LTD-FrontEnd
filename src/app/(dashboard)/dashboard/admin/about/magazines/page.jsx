  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass rounded-[2rem] border-white/5 p-20 flex flex-col items-center text-center">
        ...
        <h3 className="text-xl font-bold text-zinc-300">No Magazines Found</h3>
        <p className="text-zinc-500 mt-2 max-w-sm">The content management system for magazines is coming soon. You can soon edit titles, images, and PDF links here.</p>
      </div>
    </div>
  );
};
