...
const AddProjectPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Remove empty strings for optional URL fields to avoid validation errors
           ...
           <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-zinc-100 outline-none focus:border-brand-gold/50 transition-all font-medium text-base"
                />
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
             <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-zinc-100 outline-none focus:border-brand-gold/50 text-base"
                />
             </div>
             <div>
               ...
               <div>
                  <label className="block text-sm font-medium text-zinc-400 mb-2">Room Counts</label>
                   <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                       <input type="text" name="bedroomCount" value={formData.bedroomCount} onChange={handleChange} placeholder="Bedrooms" className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white text-base" />
                       <input type="text" name="bathroomCount" value={formData.bathroomCount} onChange={handleChange} placeholder="Bathrooms" className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white text-base" />
                       <input type="text" name="balconyCount" value={formData.balconyCount} onChange={handleChange} placeholder="Balconies" className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white text-base" />
                   </div>
               </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
               <div><label className="text-xs text-zinc-500 block mb-1">Drawing Room</label><input type="text" name="unitDetails.drawingRoom" value={formData.unitDetails.drawingRoom} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="Yes/No"/></div>
               <div><label className="text-xs text-zinc-500 block mb-1">Living Room</label><input type="text" name="unitDetails.livingRoom" value={formData.unitDetails.livingRoom} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="Yes/No"/></div>
               <div><label className="text-xs text-zinc-500 block mb-1">Dining</label><input type="text" name="unitDetails.dining" value={formData.unitDetails.dining} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="Yes/No"/></div>
               <div><label className="text-xs text-zinc-500 block mb-1">Kitchen</label><input type="text" name="unitDetails.kitchen" value={formData.unitDetails.kitchen} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="Yes/No"/></div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
               <div><label className="text-xs text-zinc-500 block mb-1">Parking</label><input type="text" name="parking" value={formData.parking} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="e.g. 1 per Flat"/></div>
               <div><label className="text-xs text-zinc-500 block mb-1">Lift</label><input type="text" name="lift" value={formData.lift} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="e.g. 1 Lift"/></div>
               <div><label className="text-xs text-zinc-500 block mb-1">Stair</label><input type="text" name="stair" value={formData.stair} onChange={handleChange} className="w-full bg-zinc-900 border border-white/10 rounded-lg px-3 py-3 text-base text-white" placeholder="e.g. Yes"/></div>
            </div>
                    ...
                    {formData.images.map((img, index) => {
                       ...
                       return (
                        <div key={index} className="relative group rounded-xl overflow-hidden aspect-video bg-zinc-900 border border-white/5">
                           <SmartImage src={imageUrl} alt={`Gallery image ${index + 1}`} fill className="object-cover" />
                           <button 
                              type="button"
                              onClick={async () => {
