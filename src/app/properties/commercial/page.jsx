...
const CommercialSpacePage = () => {
  ...
  // Pre-set filter for Commercial
  const [filters, setFilters] = useState({
    search: '',
    listingType: '',
    propertyType: 'commercial', // Fixed
    city: '',
    minPrice: '',
    maxPrice: '',
    minArea: '',
  ...
  useEffect(() => {
    fetchProperties();
  }, [filters.page, filters.listingType, filters.city, fetchProperties]);
  ...
  const AMENITIES = [
    'Parking', 'Security', 'Elevator', 'Power Backup', 
    'Wi-Fi', 'Conference Room', 'Central AC', 'CCTV'
  ];
      ...
      <section className="mb-12">
        <div className="max-container px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            <div>
              <span className="text-brand-gold font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Business Solutions</span>
              <h1 className="text-4xl md:text-5xl font-bold text-zinc-100">
                Premium <span className="text-brand-gold italic">Commercial</span> Spaces
              </h1>
            </div>
              ...
              {showFilters && (
                ...
                >
                  <div className="p-8 mt-4 glass rounded-3xl border-white/10 space-y-6">
                    {/* Row 1: Area Range (No Bedrooms/Bathrooms relevant for commercial usually, or maybe) */}
        ...
        <div className="max-container px-4">
           ...
           <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <p className="text-zinc-400">
              Showing <span className="text-zinc-100 font-bold">{properties.length}</span> commercial spaces
            </p>
             <div className="flex items-center gap-3">
          ...
          {loading ? (
            <div className="flex justify-center items-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="text-zinc-400">Loading commercial spaces...</p>
              </div>
            </div>
          ) : properties.length === 0 ? (
            <div className="text-center py-20 glass rounded-3xl border-white/5">
              ...
              <p className="text-2xl text-zinc-400 mb-4">No commercial spaces found</p>
