...
const Navbar = () => {
  ...
  useMotionValueEvent(scrollY, "change", (latest) => {
    const isScrolledDown = latest > 20;
      ...
      <div className="max-container h-full flex justify-center px-4 relative">
          ...
          <div className="absolute top-5 right-4 z-50 hidden lg:flex items-center gap-4">
            ...
            {!mounted || loading ? (
              ...
              <LiquidButton
                ...
                className="!px-4 !py-1.5 border border-brand-gold/30 !text-brand-gold !text-xs !font-bold uppercase tracking-wider min-w-[100px] h-[44px] flex items-center justify-center"
                rounded="rounded-full"
              >
                <User size={14} />
                Login
        ...
        {!isDashboard && (
          <div className="lg:hidden w-full flex justify-between items-center">
            ...
            >
                <SmartImage src="/logo-new.webp" alt="Shwapner Thikana" width={110} height={64} className="h-12 sm:h-14 w-auto object-contain transition-all" priority noBg />
            </Link>
          ...
          <div className="hidden lg:grid grid-cols-[1fr_auto_1fr] py-2 items-end w-full">
            ...
            <div className="flex justify-center">
              <Link href="/" className="hover:scale-105 transition-transform duration-300">
                  <SmartImage src="/logo-new.webp" alt="Shwapner Thikana" width={160} height={90} className="h-24 w-auto object-contain" priority noBg />
              </Link>
            </div>
        ...
        {isDashboard && (
           <Link href="/" className="hidden lg:flex items-center mr-auto">
               <SmartImage src="/logo-new.webp" alt="Shwapner Thikana" width={96} height={56} className="h-12 w-auto object-contain" noBg />
           </Link>
        )}
      </div>
        ...
        {isOpen && !isDashboard && (
          ...
          >
            ...
            <div className="mt-4 pt-4 border-t border-white/10 flex flex-col gap-4">
               {/* Mobile Utilities */}
              {!mounted ? (
                <div className="w-full h-[60px] bg-white/5 animate-pulse rounded-none"></div>
              ) : isAuthenticated ? (
                <LiquidButton
                  onClick={() => {
                    logout();
